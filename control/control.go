...
func encode_action_format3() clientmodel.ActionDefinition {
	...
	//RIC Test v2.2 ES
	format3 = []int64{0, 1, 3, 64, 0, 12, 0, 160, 86, 105, 97, 118, 105, 46, 85, 69, 46, 105, 100, 0, 0, 16, 0, 0, 0, 96, 86, 105, 97, 118, 105, 46, 67, 101, 108, 108, 46, 105, 100, 0, 0, 16, 0, 0, 0, 104, 86, 105, 97, 118, 105, 46, 77, 101, 97, 115, 49, 46, 105, 100, 0, 0, 16, 0, 0, 0, 104, 86, 105, 97, 118, 105, 46, 77, 101, 97, 115, 50, 46, 105, 100, 0, 0, 16, 0, 0, 0, 80, 68, 82, 66, 46, 85, 69, 84, 104, 112, 68, 108, 0, 0, 16, 0, 0, 0, 80, 68, 82, 66, 46, 85, 69, 84, 104, 112, 85, 108, 0, 0, 16, 0, 0, 0, 96, 82, 82, 85, 46, 80, 114, 98, 85, 115, 101, 100, 68, 108, 0, 0, 16, 0, 0, 0, 96, 82, 82, 85, 46, 80, 114, 98, 85, 115, 101, 100, 85, 108, 0, 0, 16, 0, 0, 0, 96, 86, 105, 97, 118, 105, 46, 85, 69, 46, 82, 115, 114, 112, 0, 0, 16, 0, 0, 0, 96, 86, 105, 97, 118, 105, 46, 85, 69, 46, 82, 115, 114, 113, 0, 0, 16, 0, 0, 0, 112, 86, 105, 97, 118, 105, 46, 85, 69, 46, 82, 115, 83, 105, 110, 114, 0, 0, 16, 0, 0, 0, 120, 86, 105, 97, 118, 105, 46, 77, 101, 97, 115, 49, 46, 82, 115, 114, 112, 0, 0, 16, 0, 0, 0, 120, 86, 105, 97, 118, 105, 46, 77, 101, 97, 115, 50, 46, 82, 115, 114, 112, 0, 0, 16, 0, 0, 32, 3, 231}
	return format3
}
...
func (c *Control) writeUeMetrics_db(ueMetricsMap *map[string]interface{}, timestamp int64) {
	...
	p := influxdb2.NewPointWithMeasurement("UeMetrics").
		...
		*/
		...
		AddTag("Viavi_UE_id", fmt.Sprint(ueMetric.Viavi_UE_id)).
		AddTag("Viavi_Cell_id", fmt.Sprint(ueMetric.Viavi_Cell_id)).
		AddTag("Viavi_Meas1_id", fmt.Sprint(ueMetric.Viavi_Meas1_id)).
		AddTag("Viavi_Meas2_id", fmt.Sprint(ueMetric.Viavi_Meas2_id)).
		AddField("DRB_UEThpDl", ueMetric.DRB_UEThpDl).
		AddField("DRB_UEThpUl", ueMetric.DRB_UEThpUl).
		AddField("RRU_PrbUsedDl", ueMetric.RRU_PrbUsedDl).
		AddField("RRU_PrbUsedUl", ueMetric.RRU_PrbUsedUl).
		...
		AddField("Viavi_UE_Rsrq", ueMetric.Viavi_UE_Rsrq).
		AddField("Viavi_UE_RsSinr", ueMetric.Viavi_UE_RsSinr).
		AddField("Viavi_Meas1_Rsrp", ueMetric.Viavi_Meas1_Rsrp).
		AddField("Viavi_Meas2_Rsrp", ueMetric.Viavi_Meas2_Rsrp).
		//
